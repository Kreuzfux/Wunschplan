      ...
      {isAdmin ? (
        <section className="mt-4 rounded-xl bg-white p-4 shadow">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2">
            <button className="rounded border px-3 py-2 text-sm" onClick={() ***REMOVED*** void purgeChatRetention()}>
                ...
                <li key={team.id} className="rounded border p-2">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <button className="rounded border px-3 py-1" onClick={() ***REMOVED*** void createTeamChatThread(team.id)}>
                        Teamchat anlegen
                      </button>
                      <button
